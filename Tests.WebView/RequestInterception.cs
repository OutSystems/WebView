    ...
    public class RequestInterception : WebViewTestBase {
        ...
        public async Task InterceptedResourceRequestIsLoaded() {
            await Run(async () => {
                ...
                var loaded = await TargetView.EvaluateScript<bool>("return scriptLoaded"); // check that the value of x is what was declared before in the resource
        ...
        public async Task ResourceRequestIsCanceled() {
            await Run(async () => {
                ...
                var failed = await TargetView.EvaluateScript<bool>("return scriptFailed"); // check that the value of x is what was declared before in the resource
