...
var solutionPath=@"WebViewControl.csproj";// Here you put the location of csproj file
...
var packageNuspecFile = Task("Package")
    .Does(()=>
    {
        ...
        NuGetPack(@"WebViewControl.nuspec",testSettings); //Here you need to put nuspec file location.
