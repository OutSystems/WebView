...
var solutionPath=@"ReactViewControl.csproj";// Here you put the location of csproj file
...
var packageNuspecFile = Task("Package")
    .Does(()=>
    {
        ...
        NuGetPack(@"ReactViewControl.nuspec",testSettings); //Here you need to put nuspec file location.
