...
var TopLevelTsUnit = (function (_super) {
    ...
    function TopLevelTsUnit(name, isPublic) {
...
var TsEnum = (function (_super) {
    ...
    function TsEnum(name, options, isPublic) {
        if (isPublic === void 0) { isPublic = false; }
        var _this = _super.call(this, name) || this;
        _this.name = name;
...
var TsInterface = (function (_super) {
    ...
    TsInterface.prototype.addProperty = function (unit) {
...
var TsClass = (function (_super) {
    ...
    TsClass.prototype.addProperty = function (unit) {
        this.properties.push(unit);
    };
    return TsClass;
}(TopLevelTsUnit));
exports.TsClass = TsClass;
var TsProperty = (function () {
    function TsProperty(name, type) {
        this.name = name;
        this.type = type;
    }
    return TsProperty;
