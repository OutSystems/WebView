...
var solutionPath=@"ViewGeneratorCore.csproj";// Here you put the location of csproj file
...
var packageNuspecFile = Task("Package")
    .Does(()=>
    {
        ...
        NuGetPack(@"ViewGeneratorCore.nuspec",testSettings); //Here you need to put nuspec file location.
